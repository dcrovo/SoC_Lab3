...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../div_sys.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x41078
SOPC_SYSID_FLAG += --sidp=0x41078
ELF_PATCH_FLAG  += --sidp 0x41078

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1669182123
SOPC_SYSID_FLAG += --timestamp=1669182123
ELF_PATCH_FLAG  += --timestamp 1669182123
