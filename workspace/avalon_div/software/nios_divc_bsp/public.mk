...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../avalon_div.sopcinfo
...
# Design Name 
# setting SOPC_NAME is avalon_div
SOPC_NAME := avalon_div
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x101070
SOPC_SYSID_FLAG += --sidp=0x101070
ELF_PATCH_FLAG  += --sidp 0x101070

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1665004730
SOPC_SYSID_FLAG += --timestamp=1665004730
ELF_PATCH_FLAG  += --timestamp 1665004730
